...
namespace Mentral.V
{
    public partial class Ventana_experto : Form
    {
        public Ventana_experto()
        {
            InitializeComponent();
            this.CenterToScreen();
        }
        ...
        private void CloseForms(Object sender, FormClosedEventArgs e) {
            ...
            if (Application.OpenForms["Ventana_perfil_experto"] == null) {
                boton_perfil.BackColor = SystemColors.GradientActiveCaption;
                emoticon_perfil.BackColor = SystemColors.GradientActiveCaption;
            }
            if (Application.OpenForms["Ventana_ver"] == null)
            {
                boton_ver.BackColor = SystemColors.GradientActiveCaption;
                emoticon_ver.BackColor = SystemColors.GradientActiveCaption;
            }
            if (Application.OpenForms["Ventana_incorporar"] == null)
            {
                boton_incorporar.BackColor = SystemColors.GradientActiveCaption;
                emoticon_incorporar.BackColor = SystemColors.GradientActiveCaption;
            }
            if (Application.OpenForms["Ventana_manual_experto"] == null)
            {
            ...
            if (Application.OpenForms["Ventana_modificar"] == null)
            {
                boton_modificar.BackColor = SystemColors.GradientActiveCaption;
                emoticon_modificar.BackColor = SystemColors.GradientActiveCaption;
            }
        }
        #endregion
        #region Eventos
        ...
        {
            AbrirFormulario<Ventana_modificar>();
            boton_modificar.BackColor = SystemColors.MenuHighlight;
            emoticon_modificar.BackColor = SystemColors.MenuHighlight;
        }

        private void Boton_ver_Click(object sender, EventArgs e)
        {
            AbrirFormulario<Ventana_ver>();
            boton_ver.BackColor = SystemColors.MenuHighlight;
            emoticon_ver.BackColor = SystemColors.MenuHighlight;
        }   

        private void Boton_incoporar_click(object sender, EventArgs e)
        {
            AbrirFormulario<Ventana_incorporar>();
            boton_incorporar.BackColor = SystemColors.MenuHighlight;
            emoticon_incorporar.BackColor = SystemColors.MenuHighlight;
        }
        private void Boton_manual_usuario_click(object sender, EventArgs e)
        {
            AbrirFormulario<Ventana_manual_experto>();

...
namespace Mentral.V
{
    public partial class Ventana_principal : Form
    {
        ...
        /*Metodo para arrastrar el formulario cuando el windowsform tiene no tiene borde, aqui la clave es usar metodos externos de la API de Windows*/
        [DllImport("user32.DLL", EntryPoint = "ReleaseCapture")]
        /*Antes de mandar el mensaje debemos hacer releasecapture*/
        private extern static void ReleaseCapture();
        /*hWnd es el identificador de la ventana que capturo*/
        ...
        private void CloseForms(Object sender, FormClosedEventArgs e) {
            ...
            if (Application.OpenForms["Ventana_perfil"] == null) {
            ...
            if (Application.OpenForms["Ventana_configuración"] == null)
            {
                boton_configuracion.BackColor = SystemColors.GradientActiveCaption;
                emoticon_configuracion.BackColor = SystemColors.GradientActiveCaption;
            }
        }
        #endregion
        #region Eventos
        ...
        {
            AbrirFormulario<Ventana_perfil>();
        ...
        {
            AbrirFormulario<Ventana_responder_cuestionario>();
        ...
        {
            AbrirFormulario<Ventana_configuracion>();
            boton_configuracion.BackColor = SystemColors.MenuHighlight;
            emoticon_configuracion.BackColor = SystemColors.MenuHighlight;
        }
